...
SRC_URI="https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.17%2B10/OpenJDK17U-jdk-sources_17.0.17_10.tar.gz -> OpenJDK17U-jdk-sources_17.0.17_10.tar.gz"

LICENSE="GPL-2"
KEYWORDS="*"
SLOT="$(ver_cut 1)"
IUSE="alsa big-endian cups debug doc examples +gentoo-vm headless-awt javafx selinux source systemtap"
